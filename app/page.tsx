...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-darkNavy ">
      <div className='flex flex-col items-center justify-center w-[328px] sm:w-[460px]'>
        ...
        <div className='bg-semidarknavy p-4 rounded-2xl w-full flex flex-col items-center shadow-[0_8px_0_0_#10212A] my-6 '>
